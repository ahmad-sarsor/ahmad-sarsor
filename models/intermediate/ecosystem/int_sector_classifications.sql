...
with company_classifications as (
    ...
    where base_classification_company.classification_category in('SectorClassificationModel','SectorClassificationRelationModel')
        and base_classification.classification_type in('SectorClassificationModel','SectorClassificationRelationModel')
),
...
classifications as (
    ...
    where classification_type in('SectorClassificationModel','SectorClassificationRelationModel')
),
